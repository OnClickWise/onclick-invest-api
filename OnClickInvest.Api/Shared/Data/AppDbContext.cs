    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Subscription>(entity =>
            {
                ...
                entity.Property(s => s.StartAt).IsRequired();
            ...
            modelBuilder.Entity<Projection>(entity =>
            {
                ...
                entity.HasKey(p => p.Id);
                entity.Property(p => p.InitialCapital).HasPrecision(18, 2);
                entity.Property(p => p.MonthlyContribution).HasPrecision(18, 2);
                entity.Property(p => p.Years).IsRequired();
                entity.Property(p => p.CreatedAt).IsRequired();
            ...
            modelBuilder.Entity<ProjectionSnapshot>(entity =>
            {
                ...
                entity.HasKey(s => s.Id);
                entity.Property(s => s.TotalInvested).HasPrecision(18, 2);
        ...
        private List<AuditLog> OnBeforeSaveChanges()
        {
            ...
            foreach (var entry in ChangeTracker.Entries())
            {
                ...
                if (tenantProp?.CurrentValue != null)
                    audit.TenantId = (Guid?)tenantProp.CurrentValue;

                var key = entry.Properties
                    .FirstOrDefault(p => p.Metadata.IsPrimaryKey());

                if (key?.CurrentValue != null)
                    audit.EntityId = key.CurrentValue.ToString()!;
